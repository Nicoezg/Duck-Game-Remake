...
GameCreation::GameCreation(int game_code, int player_id_1, int player_id_2, int actual_players, int max_players)
    : Event(CREATE_GAME), game_code(game_code), player_id_1(player_id_1),
      player_id_2(player_id_2), actual_players(actual_players), max_players(max_players) {}
