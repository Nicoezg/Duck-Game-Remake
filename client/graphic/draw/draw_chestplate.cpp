...
DrawChestplate::DrawChestplate(SDL2pp::Renderer &renderer, bool equipped) : renderer(renderer), equipped(equipped) {
    this->textures[0] = std::make_shared<SDL2pp::Texture>(renderer, SDL2pp::Surface(DATA_PATH "equipment/chestplate.png"));
    this->textures[1] = std::make_shared<SDL2pp::Texture>(renderer, SDL2pp::Surface(DATA_PATH "equipment/chestplate-equipped-1.png"));
}
